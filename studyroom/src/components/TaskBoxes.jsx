...
import CarouselThings from "../styles/CarouselThings.js"
  ...
  return (
    ...
    className = "flex items-center justify-center">
      <a href = "/NewTask" draggable = "false">
        <button class="cursor-pointer px-10 h-48 rounded text-white text-xl font-extrabold" draggable = "false">
        NEW TASK
        <img src="/assets/TaskPic1.jpeg" alt = "TaskPic1" width = "200"
        className="image rounded" draggable = "false"/>
